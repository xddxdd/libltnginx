...
('393216', '4199999999', 'whois.arin.net'),

# private ASN block
('4200000000', '4294967294', 'whois.ripe.net'),
# reserved
('4294967295', '4294967295', 'whois.ripe.net'),
]

# print('local asn = tonumber(ngx.var.asn);')
# for start, end, server in as_list:
#     print('if asn >= %s and asn <= %s then return "%s" end' % (start, end, server))
# print('return "whois.arin.net"')

for start, end, server in as_list:
    print('    {%s, %s, "%s"},' % (start, end, server))
